...
addJetCollection(process,cms.InputTag('JetPlusTrackZSPCorJetAntiKt5'),
                 ...
                 doJTA        = True,
                 doBTagging   = True,
                 jetCorrLabel = ('AK5JPT' + jecPostfix, cms.vstring(['L1JPTOffset', 'L2Relative', 'L3Absolute', 'L2L3Residual'])),
                 doType1MET   = False,
                 doL1Cleaning = False,
                 doL1Counters = True,                 
...
addJetCollection(process,cms.InputTag('ak7CaloJets'),
                 ...
                 doJTA        = True,
                 doBTagging   = False,
                 jetCorrLabel = ('AK7Calo' + jecPostfix, cms.vstring(['L2Relative', 'L3Absolute'])),
                 doType1MET   = True,
                 doL1Cleaning = True,                 
                 doL1Counters = False,
...
addJetCollection(process,cms.InputTag('kt4CaloJets'),
                 ...
                 doJTA        = True,
                 doBTagging   = True,
                 jetCorrLabel = ('KT4Calo' + jecPostfix, cms.vstring(['L2Relative', 'L3Absolute'])),
                 doType1MET   = True,
                 doL1Cleaning = True,                 
                 doL1Counters = False,
...
addJetCollection(process,cms.InputTag('kt6CaloJets'),
                 ...
                 doJTA        = True,
                 doBTagging   = False,
                 jetCorrLabel = ('KT6Calo' + jecPostfix, cms.vstring(['L2Relative', 'L3Absolute'])),
                 doType1MET   = False,
                 doL1Cleaning = True,                 
                 doL1Counters = False,
...
switchJetCollection(process,cms.InputTag('ak5PFJets'),
                 doJTA        = True,
                 doBTagging   = True,
                 jetCorrLabel = ('AK5PF' + jecPostfix, cms.vstring(['L2Relative', 'L3Absolute', 'L2L3Residual'])),
                 doType1MET   = True,
                 genJetCollection=cms.InputTag("ak5GenJets"),
                 doJetID      = True
                 )
