...
MultiIsolator::MultiIsolator(const edm::ParameterSet &conf, bool cuts) {
    ...
    if (conf.exists("particle")) addIsolator(conf.getParameter<edm::ParameterSet>("particle"), cuts,Flags::Isolation::Calo, pat::ParticleIso);
   if (conf.exists("chargedparticle")) addIsolator(conf.getParameter<edm::ParameterSet>("chargedparticle"), cuts,Flags::Isolation::Calo, pat::ChargedParticleIso);
   if (conf.exists("neutralparticle")) addIsolator(conf.getParameter<edm::ParameterSet>("neutralparticle"), cuts,Flags::Isolation::Calo, pat::NeutralParticleIso);
   if (conf.exists("gammaparticle")) addIsolator(conf.getParameter<edm::ParameterSet>("gammaparticle"), cuts,Flags::Isolation::Calo, pat::GammaParticleIso);
    if (conf.exists("user")) {
